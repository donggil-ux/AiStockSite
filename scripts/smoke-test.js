...
const tests = [
    ...
    { name: 'naver-board: US sym ok',method: 'GET',  path: '/api/naver-board/AAPL',              expectCodes: [200] },
    { name: 'naver-board: invalid',  method: 'GET',  path: '/api/naver-board/!!INVALID',         expectCodes: [400] },
