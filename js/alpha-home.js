...
// 의존: state.js, utils.js, api.js
    ...
    function _renderDailyTrading() {
        ...
        if (!rows.length) {
            ...
            } else if (d.middayFiltered) {
                msg = '🍱 미국 점심 시간대 — 진입 회피 중';
                sub = '점심 횡보장(15:30~18:30 UTC)은 백테스트상 승률이 낮아 신호를 내보내지 않습니다.<br>장초반·파워아워에 신호가 갱신됩니다.';
            } else {
                msg = 'Smart Dip 조건을 충족하는 종목이 없습니다';
                sub = '추세·거래량·진입봉 8개 필터를 통과한 후보는 장중에 실시간 갱신됩니다.';
            }
